...
from scripts.utils import run_script_with_kwargs
...
shared_kwargs = dict(
    ...
    lr_scheduler_class_name='MultiStepLR',
...
for seed in range(n_seeds):
    for training_set_size in training_set_sizes:
        ...
        kwargs['log_dir'] = os.path.join('ResNet20AccRegUQOOD',
        ...
        for beta in [0.001, 0.0001, 0.00001, 0]:
            ...
            kwargs['model_kwargs']['net_kwargs']['out_dim'] = 20
            kwargs['train_size'] = training_set_size
            kwargs['model_kwargs']['beta'] = beta
            kwargs['model_kwargs']['n_mixture_components'] = 10
            kwargs['model_kwargs']['covariance_type'] = 'diag'
            kwargs['model_kwargs']['train_var_dist_samples'] = 10
            kwargs['model_kwargs']['test_var_dist_samples'] = 20
            device_id = device_cycle.__next__()
            kwargs['device_id'] = device_id
            kwargs['log_dir'] = os.path.join('ResNet20AccRegUQOOD',
                                             kwargs['model_class_name'],
